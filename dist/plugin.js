var capacitorCactus = (function (exports, core) {
    'use strict';

    const CactusCap = core.registerPlugin('CactusCap', {
        web: () => Promise.resolve().then(function () { return web; }).then(m => new m.CactusCapWeb()),
    });

    class CactusCapWeb extends core.WebPlugin {
        constructor() {
            super(...arguments);
    ...
    var web = /*#__PURE__*/Object.freeze({
        __proto__: null,
        CactusCapWeb: CactusCapWeb
    });

    exports.CactusCap = CactusCap;
